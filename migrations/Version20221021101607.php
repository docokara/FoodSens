 ...
 */
final class Version20221021101607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, tags JSON NOT NULL, steps JSON NOT NULL, people INT NOT NULL, budget INT NOT NULL, difficulty INT NOT NULL, preptime INT NOT NULL, toltal_time INT NOT NULL, ingredients JSON NOT NULL, INDEX IDX_DA88B137F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
